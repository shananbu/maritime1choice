          ...
          <article>
            <div class="panel-group" id="accordion">
              ...
              <div class="panel panel-default"><a data-toggle="collapse" class="panel-heading"
                                                                        data-parent="#accordion" href="#collapseOne"> <span> <?php echo $row['title'] ?>, <?php echo $row['location'] ?> </span> <b>More
                Info</b> </a>
              ...
              <p class="te_ali_justify"> 
                ...
                for new talents and recruits , please send your CV along with a cover letter, to <a href="mailto:hr@maritime1stchoice.com"> hr@maritime1stchoice.com </a> </p>
              <?php } ?>
            </div>
          </article>
        </section>
