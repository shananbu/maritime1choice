...
<div class="wrapper">
    ...
    <section class="banner_row"><img src="images/banner_1.jpg">
        <article>
            <p class="container">
	<span>Maritime1stChoice will act as
            ...
            <div class="row te_ju">
                ...
                <div class="why_choose ad_pa" id="why_mic">
                    ...
                    <p> Our corporate philosophy is built on the premise that our service to our clients and customers
                        ...
                        <br>
                        <b class="bold-font">Novell VIBE:</b> we use vibe as a shared platform and as a client you are allowed to take
                        full
                ...
                <div class="ad_pa" id="mis_val">
                    ...
                    <p>With a MISSION to secure the value for our clients investment in shipping software by providing
                        ...
                        cost effective manner. Maritime1stChoice VISION is to be the <b class="bold-font">1st Choice IT service provider
                            within the shipping industry.</b>
                        <br> <br>
                    <h1 class="h_2"> Fundamental Principles </h1> QUALITY – Quality is of Utmost importance to M1C, as
                    Quality leads to trust and Trust Leads to lasting business relationship with our client. <br><br>
                    TRANSPARENY & TRUST – Transparency is an assurance and it goes hand in hand with trust. It will be a
                    part of collective decision making and maintain continuous dialogue with M1C. <br><br> Through
                    customer collaboration cooperation and collective decision making M1C is able to assure the client
                    <b class="bold-font">“Value for their investment”.</b>
                    </p>
                </div>
            </div>
        </div>
